    ...
    extend: {
      colors: {
        ...
        game: {
          ...
          player: "hsl(var(--player-area))",
          enemy: "hsl(var(--enemy-area))",
          mana: "hsl(var(--mana-crystal))",
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(var(--card-glow) / 0.5)",
          },
          "50%": {
            boxShadow: "0 0 30px hsl(var(--card-glow) / 0.8)",
          },
        },
        "float": {
          "0%, 100%": {
